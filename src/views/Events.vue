    ...
    <v-container fluid class="pt-3 mb-0 grey lighten-5">
      <v-layout wrap align-center justify-center row fill-height class="my-0">
        <v-flex xs12 md10 class="my-0">
            <p class="google-font mb-0" style="font-size:200%;color:#0277bd">{{ $t('Events.Events') }}</p>
            <p class="google-font mt-0 mb-0" style="font-size:110%">{{ $t('Events.Questions') }} {{ChapterInfos.ChapterEmail}}.</p>
        </v-flex>
      </v-layout>
    </v-container>
