<template>
    <v-container class="pa-0 pb-5">
        <v-layout wrap align-center justify-center row fill-height>
            <v-flex xs12 md12>
                <p class="google-font mt-2 mb-0" style="font-size:170%;color:#37474F;" >{{ $t('Partners.OurPartners') }}</p>
                <p class="google-font mt-1 mb-0" style="font-size:120%">{{ $t('Partners.Thank') }}</p>
                <p class="google-font mt-0" style="font-size:120%">{{ $t('Partners.Interested') }} <b>{{ $t('ChapterName') }}</b>, {{ $t('Partners.Contact') }} <a style="color:#1565C0;text-decoration: none;" :href="`mailto:${ChapterInfos.ChapterEmail}`">{{ChapterInfos.ChapterEmail}}</a> {{ $t('Partners.Discuss') }}</p>
            </v-flex>
                        ...
                        <v-card class="elevation-0 pa-0 ma-0 transparent">
                            <v-container grid-list-sm fluid class="pa-0 ma-0">
                                <v-layout row wrap class="ma-0 pa-0">
                                    <v-flex
                                        v-for="(itemp,i) in generalPartnersData" :key="i"
                                        xs6
                                        md3
                                        sm4
                                        d-flex
                    ...
                    <v-flex xs12 sm7 class="elevation-0 transparent">
                        <v-card class="elevation-0 pa-0 ma-0 transparent">
                            <v-container grid-list-sm fluid class="pa-0 ma-0">
                                <v-layout row wrap class="ma-0 pa-0">
                                    <v-flex
                                        v-for="(itemp,i) in communityPartnersData" :key="i"
                                        xs6
                                        md3
                                        sm4
                                        d-flex
...
export default {
    data() {
        return {
            generalPartnersData: partnersData.General,
            communityPartnersData: partnersData.Community,
